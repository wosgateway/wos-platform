...
-- resolved label (e.g. "ðŸ›‚ à¸”à¹ˆà¸²à¸™à¸«à¸™à¸­à¸‡à¸„à¸²à¸¢ (à¸ªà¸°à¸žà¸²à¸™à¸¡à¸´à¸•à¸£à¸ à¸²à¸žà¹„à¸—à¸¢-à¸¥à¸²à¸§)" or
-- "ðŸ¨ à¹‚à¸£à¸‡à¹à¸£à¸¡ (à¸£à¸°à¸šà¸¸à¸Šà¸·à¹ˆà¸­): Some Hotel") is sent to /api/orders as
